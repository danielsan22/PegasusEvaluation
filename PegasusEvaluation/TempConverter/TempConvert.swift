 ...
 public class TempConvert {
    public var Url:String = "https://www.w3schools.com/xml/tempconvert.asmx"
    public var Host:String = "www.w3schools.com"
    ...
    public func FahrenheitToCelsius(Fahrenheit:String)-> String{
        ...
        soapReqXML += "<FahrenheitToCelsius xmlns=\"https://www.w3schools.com/xml/\">"
        soapReqXML += "<Fahrenheit>"
        soapReqXML += Fahrenheit
        soapReqXML += "</Fahrenheit>"
        soapReqXML += "</FahrenheitToCelsius>"
        soapReqXML += "</soap:Body>"
        soapReqXML += "</soap:Envelope>"
        
        let soapAction :String = "https://www.w3schools.com/xml/FahrenheitToCelsius"
    ...
    public func CelsiusToFahrenheit(Celsius:String)-> String{
        var soapReqXML:String = "<?xml version=\"1.0\" encoding=\"utf-8\"?>"
        ...
        soapReqXML  += " xmlns:soap =\"http://schemas.xmlsoap.org/soap/envelope/\">"
        soapReqXML += " <soap:Body>"
        soapReqXML += "<CelsiusToFahrenheit xmlns=\"https://www.w3schools.com/xml/\">"
        soapReqXML += "<Celsius>"
        soapReqXML += Celsius
        soapReqXML += "</Celsius>"
        soapReqXML += "</CelsiusToFahrenheit>"
        soapReqXML += "</soap:Body>"
        soapReqXML += "</soap:Envelope>"
        
        let soapAction :String = "https://www.w3schools.com/xml/CelsiusToFahrenheit"
